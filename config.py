...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/anujkumarroy/Iro_x")
...
if not MUSIC_BOT_NAME.isascii():
    print(
        "[KYA RE LAVDE] - BOHOT FONT LAGANE KA SHAUKH HAI. JAA PHIR NYKAA KO APNI CHUMT DEKE AA"
    )
